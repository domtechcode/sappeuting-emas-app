                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nomor_keluarga_indonesia" type="text" class="form-control" placeholder="Nomor Kartu Keluarga"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nama_kepala_keluarga" type="text" class="form-control"
                                                        placeholder="Nama Kepala Keluarga" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="status_keluarga" type="text" class="form-control"
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-dark"><i class="fe fe-search me-2"></i>Mulai Validasi</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Nomor Kartu Keluarga Indonesia / Nama Kepala Keluarga</h5>
                                    <form method="POST" action="">
                                        @csrf
                                        <div class="form-group">
                                            <input name="nomor_keluarga_indonesia" type="text" class="form-control"
                                                placeholder="Nomor Kartu Keluarga Indonesia / Nama Kepala Keluarga" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-dark"><i class="fe fe-search me-2"></i>Cari</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

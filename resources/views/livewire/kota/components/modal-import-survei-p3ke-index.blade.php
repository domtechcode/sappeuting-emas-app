<div>
    <div class="modal fade" wire:ignore.self id="modalImportSurveiP3ke" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Import Survei KRS</h5>
...
@push('scripts')
    <script>
        window.addEventListener('closeModalAndReset', event => {
            $('#modalImportSurveiP3ke').modal('hide');
        });
    </script>
@endpush
